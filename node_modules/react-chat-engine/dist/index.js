...
var Socket = function Socket(props) {
  ...
  function onConnect(conn) {
    ...
    setCreds(conn);
    setConnecting(false);
    getLatestChats(conn, 25, function (chats) {
...
var ChatCard = function ChatCard(props) {
  ...
  }, chat.is_direct_chat && otherPerson ? otherPerson.person.username : chat.title, !readLastMessage(chat) && /*#__PURE__*/React__default.createElement("div", {
...
var ChatList = function ChatList(props) {
  ...
  function renderChats(chats) {
    return chats.map(function (chat, index) {
      if (!chat) {
        ...
        }, /*#__PURE__*/React__default.createElement(ChatCard, {
          chat: chat
        }));
      }
    });
  ...
  }, props.renderNewChatForm ? props.renderNewChatForm(conn) : /*#__PURE__*/React__default.createElement(NewChatForm, null), renderChats(chatList), hasMoreChats && chatList.length > 0 && /*#__PURE__*/React__default.createElement(ChatLoader, {
...
var ConnectionBar = function ConnectionBar() {
  ...
  if (!connecting) return /*#__PURE__*/React__default.createElement("div", null);
  return /*#__PURE__*/React__default.createElement("div", {
    style: {
      zIndex: '1',
      bottom: '66px',
...
var ChatListDrawer = function ChatListDrawer(props) {
  ...
  }, "My Chats")), /*#__PURE__*/React__default.createElement(ChatList, _extends({}, props, {
...
var PeopleSettings = function PeopleSettings(props) {
  ...
  }, "People"), state.collapsed ? /*#__PURE__*/React__default.createElement(icons.LeftOutlined, {
    style: styles$5.collapseIcon
  }) : /*#__PURE__*/React__default.createElement(icons.DownOutlined, {
    style: styles$5.collapseIcon
  })), !state.collapsed && /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", {
    style: {
      height: '12px'
    }
  ...
  }), props && chat && props.userName === chat.admin.username && /*#__PURE__*/React__default.createElement(PersonForm, {
    conn: props,
    chat: chat
  })));
};
...
var PhotosSettings = function PhotosSettings(props) {
  ...
  }, "Photos"), state.collapsed ? /*#__PURE__*/React__default.createElement(icons.LeftOutlined, {
    style: styles$7.collapseIcon
  }) : /*#__PURE__*/React__default.createElement(icons.DownOutlined, {
    style: styles$7.collapseIcon
  })), !state.collapsed && /*#__PURE__*/React__default.createElement("div", {
...
var OptionsSettings = function OptionsSettings(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, "Options"), state.collapsed ? /*#__PURE__*/React__default.createElement(icons.LeftOutlined, {
    ...
    icon: "delete",
    onClick: function onClick() {
      return reactChatEngine.deleteChat(props, chat.id, function (data) {});
    },
    style: {
      width: '100%',
      marginBottom: '12px'
...
var ChatSettings = function ChatSettings(props) {
  ...
  }, props.renderChatSettingsTop ? props.renderChatSettingsTop(conn, chat) : /*#__PURE__*/React__default.createElement(ChatSettingsTop, _extends({}, props, {
    chat: chat
  })), props.renderPeopleSettings ? props.renderPeopleSettings(conn, chat) : /*#__PURE__*/React__default.createElement(PeopleSettings, _extends({}, props, {
    chat: chat
  })), props.renderPhotosSettings ? props.renderPhotosSettings(chat) : /*#__PURE__*/React__default.createElement(PhotosSettings, _extends({}, props, {
    chat: chat
  })), props && chat && props.userName === chat.admin.username && /*#__PURE__*/React__default.createElement("div", null, props.renderOptionsSettings ? props.renderOptionsSettings(conn, chat) : /*#__PURE__*/React__default.createElement(OptionsSettings, _extends({}, props, {
    chat: chat
  })))));
};
var styles$9 = {
...
var Message = function Message(props) {
  ...
  }, renderAttachments()), /*#__PURE__*/React__default.createElement(reactGridSystem.Row, {
    style: {
      paddingRight: '2px'
    },
...
var TheirMessage = function TheirMessage(props) {
  ...
  }, renderAttachments()), !attachments || message.text && /*#__PURE__*/React__default.createElement("div", {
    style: {
      paddingLeft: '48px'
    }
  }, /*#__PURE__*/React__default.createElement("div", {
...
var SendingMessage = function SendingMessage(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: "ce-my-message-attachments-container"
  }, renderAttachments(attachments)), /*#__PURE__*/React__default.createElement(reactGridSystem.Row, {
    style: {
      paddingRight: '2px'
    },
...
var Messages = function Messages(props) {
  ...
  return keys.map(function (key, index) {
    ...
    }), index === 0 && /*#__PURE__*/React__default.createElement(RenderTrigger, {
      onEnter: function onEnter() {
...
var NewMessageForm$1 = function NewMessageForm() {
  ...
  function handleChange(event) {
    ...
    if (state.trigger === 1) {
      reactChatEngine.isTyping(conn, activeChat);
    }
  }
  ...
  function handleSubmit(event) {
    ...
    if (text.length > 0 || attachments.length > 0) {
      reactChatEngine.sendMessage(conn, activeChat, data, function (data) {});
    }
  ...
  }, /*#__PURE__*/React__default.createElement(FileRow, {
...
var ChatFeed = function ChatFeed(props) {
  ...
  }), /*#__PURE__*/React__default.createElement(Messages, props), /*#__PURE__*/React__default.createElement(SendingMessages, props), /*#__PURE__*/React__default.createElement(Typers, {
    currentTime: currentTime
  }), /*#__PURE__*/React__default.createElement(ConnectionBar, null), /*#__PURE__*/React__default.createElement("div", {
    style: {
      height: '54px'
    },
...
var ChatEngine = function ChatEngine(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(Socket, props), /*#__PURE__*/React__default.createElement(reactGridSystem.Row, null, /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 0,
    sm: 3,
    style: {
      height: height ? height : ''
    }
  }, /*#__PURE__*/React__default.createElement(ChatList, propsAndContext)), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 12,
    sm: 6,
    style: {
      height: height ? height : ''
    }
  }, /*#__PURE__*/React__default.createElement(ChatFeed, propsAndContext)), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 0,
    sm: 3,
    style: {
      height: height ? height : ''
    }
  }, /*#__PURE__*/React__default.createElement(ChatSettings, propsAndContext))));
};
...
var Avatar = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      className: "ce-avatar",
      style: _extends({}, styles$l.avatar, customStyle, {
        backgroundColor: this.state.avatar ? 'white' : color,
        backgroundImage: this.state.avatar && "url(" + this.state.avatar + ")",
        backgroundRepeat: 'no-repeat',
        backgroundPosition: 'center',
